package Hash.OBHT.ProverkaNaSpeluvanje_Daden_Zbor_E_Pravilno_Napishan_Vo_Tekst;
...
public class ProverkaNaSpeluvanje_Daden_Zbor_E_Pravilno_Napishan_Vo_Tekst {
    public static void main(String[] args) throws IOException {
        ...
        for (i = 0; i < pom.length; i++) {
            ...
            h = tabela.search(word);
            if (h == -1) {
                System.out.println(word); // wordOriginal, ako se bara kako shto e napishan vo tekstot
                flag = 0; // counter++;
            }
        }
        if (flag == 1) { // if(counter == 0){}
            System.out.println("Bravo");
        }
    }
}
