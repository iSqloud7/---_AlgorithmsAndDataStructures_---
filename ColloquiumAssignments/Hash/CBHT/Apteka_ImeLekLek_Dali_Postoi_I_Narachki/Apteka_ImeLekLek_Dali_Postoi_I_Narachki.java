package Hash.CBHT.Apteka_ImeLekLek_Dali_Postoi_I_Narachki;
...
class Lek {
    ...
    public Lek(String name, int pos_neg, int price, int quantity) {
        this.name = name.toUpperCase();
...
public class Apteka_ImeLekLek_Dali_Postoi_I_Narachki {
    public static void main(String[] args) throws IOException {
        ...
        for (i = 0; i < n; i++) {
            ...
            imeLek = new ImeLek(name);
            lek = new Lek(name, positive_negative, price, quantity);
            tabela.insert(imeLek, lek);
        }
