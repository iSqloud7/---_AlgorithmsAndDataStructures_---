package SingleLinkedList.Students_Brishenje_Student_So_Najmal_Broj_Poeni.Student;
...
public class Student_Brishenje_Student_So_Najmal_Broj_Poeni {
    public static void removeStudent(SLL students) {
        SLLNode tmp = students.first;
        SLLNode minPoints = students.first;
        while (tmp != null) {
            if (tmp.points < minPoints.points) {
                minPoints = tmp;
            }
            tmp = tmp.succ;
        }
