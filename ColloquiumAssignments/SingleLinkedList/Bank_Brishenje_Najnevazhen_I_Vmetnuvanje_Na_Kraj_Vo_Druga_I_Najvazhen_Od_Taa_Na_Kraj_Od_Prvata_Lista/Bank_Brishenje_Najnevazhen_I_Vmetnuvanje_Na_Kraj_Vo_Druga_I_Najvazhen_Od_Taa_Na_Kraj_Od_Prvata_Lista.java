package SingleLinkedList.Bank_Brishenje_Najnevazhen_I_Vmetnuvanje_Na_Kraj_Vo_Druga_I_Najvazhen_Od_Taa_Na_Kraj_Od_Prvata_Lista;
...
public class Bank_Brishenje_Najnevazhen_I_Vmetnuvanje_Na_Kraj_Vo_Druga_I_Najvazhen_Od_Taa_Na_Kraj_Od_Prvata_Lista {
    public static void bank(SLL<Client> normal, SLL<Client> golden) {
        ...
        while (tmp != null) {
            if (tmp.element.calculateImportance() < leastImportant.element.calculateImportance()) {
                leastImportant = tmp;
            }
            tmp = tmp.succ;
        }
        ...
        while (tmp != null) {
            if (tmp.element.calculateImportance() > mostImportant.element.calculateImportance()) {
                mostImportant = tmp;
            }
            tmp = tmp.succ;
        }
