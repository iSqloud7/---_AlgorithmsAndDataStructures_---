package DoubleLinkedList.Palindrome;
...
public class Palindrome {
    public static int Palindrome(DLL<Integer> list) {
        ...
        while (start != end && end.pred != start) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int result = Palindrome(lista1);
        System.out.println("Листата е: " + lista1);
        System.out.println("Дали е палиндром? " + result);
    }
}
